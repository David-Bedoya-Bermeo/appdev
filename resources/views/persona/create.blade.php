...
<input type="text" name="nombre" id="nombre" class="formcontrol" placeholder="Nombre Completo">
</div>
</div>
<div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
<div class="form-group">
<label for="apellido">Apellidos</label>
<input type="text" name="apellido" id="apeliido" class="formcontrol" placeholder="Apellidos Completos">
</div>
</div>
<div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
<div class="form-group">
...
<input type="text" name="telefono" id="telefono" class="formcontrol" placeholder="Telefono">
</div>
</div>
